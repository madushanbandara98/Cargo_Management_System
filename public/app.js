...
async function openShipment(shipment, pushHistory = true) {
  ...
  panel.querySelector('style').textContent += `.shipment-page .customer-grid>label,.shipment-page .customer-grid>label.wide,.shipment-page .customer-grid>label:nth-child(8),.shipment-page .customer-grid>label:nth-child(9){grid-column:span 4!important}.shipment-page .customer-grid>label:nth-child(10),.shipment-page .customer-grid>label:nth-child(11){grid-column:span 3!important}@media(max-width:900px){.shipment-page .customer-grid>label,.shipment-page .customer-grid>label.wide,.shipment-page .customer-grid>label:nth-child(8),.shipment-page .customer-grid>label:nth-child(9),.shipment-page .customer-grid>label:nth-child(10),.shipment-page .customer-grid>label:nth-child(11){grid-column:span 1!important}}`;
...
function enableCustomerAutofill(form) {
  ...
  reference.addEventListener('change', async () => {
    ...
    try {
      ...
      const values = { customerName:customer.customer_name, customerId:customer.customer_id, pickupContactName:customer.pickup_contact_name, germanAddress:customer.german_address, deliveryContactName:customer.delivery_contact_name, sriLankanAddress:customer.sri_lankan_address, phoneDE:customer.phone_de, phoneLK:customer.phone_lk };
...
function enableCustomerEnterNavigation(form) {
  const fields = ['customerRef', 'customerName', 'customerId', 'pickupContactName', 'germanAddress', 'phoneDE', 'deliveryContactName', 'sriLankanAddress', 'phoneLK', 'ratePerCubic', 'deliveryCharge'].map(name => form.elements[name]);
